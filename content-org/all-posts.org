...
サーチコンソール
ゲーム感想 → ケーム感想になってた
** DRAFT Hugo Academic でダーク・ライト両モードに対応した Chroma によるシンタックスハイライト
:PROPERTIES:
:EXPORT_FILE_NAME:   index
:EXPORT_DATE:        2020-01-23
...
[[https://sourcethemes.com/academic/][Academic テーマ]] のデフォルト設定は 
...
https://xyproto.github.io/splash/docs/algol_nu.html
...
https://xyproto.github.io/splash/docs/rainbow_dash.html
